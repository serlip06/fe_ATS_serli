...
`
    <tr class="border-b border-gray-200 ">
                            ...
                            <td class="px-6 py-4 whitespace-no-wrap bg-white text-sm font-medium text-coolGray-800 text-center">#PHONE_NUMBER#</td>
                             <td class="whitespace-nowrap px-4 bg-white text-sm font-medium text-coolGray-500 text-left">#ALAMAT#</td>
                            <td class="px-6 py-4 whitespace-no-wrap bg-white  text-sm font-medium coolGray-500">
                                <a href="#">#EMAIL#</a>
                            </td>
