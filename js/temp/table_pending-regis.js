...
<tr class="h-18 border-b border-coolGray-100">
                              ...
                              <td class="whitespace-nowrap px-4 bg-white text-sm font-medium text-coolGray-800 text-left">#USERNAME#</td>
                              <td class="whitespace-nowrap px-4 bg-white text-sm font-medium text-coolGray-800 text-center">#PASSWORD#</td>
                              <td class="whitespace-nowrap px-4 bg-white text-sm font-medium text-coolGray-500 text-left">#ROLE#</td>
                              <td class="whitespace-nowrap px-4 bg-white text-sm font-medium text-blue-500 text-left">#SUBMITTED_AT#</td>
                               <td class="whitespace-nowrap pr-4 bg-white text-sm font-medium text-coolGray-800">
                                <a class="inline-block px-3 py-1 bg-yellow-500 text-white rounded-lg cursor-pointer shadow-md active:scale-95 transition-transform accept-btn" href="#ID#" data-id="#ID#">Terima</a>
                                </td>
                              <td class="whitespace-nowrap pr-4 bg-white text-sm font-medium text-coolGray-800">
