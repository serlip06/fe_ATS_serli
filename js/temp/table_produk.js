...
`
    <tr class="border-b border-gray-200 ">
                            ...
                            <a class="inline-block px-3 py-1 bg-yellow-500 text-white rounded-lg cursor-pointer shadow-md active:scale-95 transition-transform" type="button" href="edit.html?produkID=#IDEDIT#">Edit</a>
